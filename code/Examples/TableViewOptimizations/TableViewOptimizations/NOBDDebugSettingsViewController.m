//
//  NOBDDebugSettingsViewController.m
...
@interface NOBDDebugSettingsViewController ()

@end

@implementation NOBDDebugSettingsViewController
{
...
- (id)init
{
    self = [super initWithNibName:@"NOBDDebugSettingsViewController" bundle:nil];
    if (self) {
